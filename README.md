...
## FairyStack Companion is a separate app

Voice Feed 1.6.1 removes the temporary Mac command integration. Updating revokes
and removes its old command credential; capture credentials are unchanged.
