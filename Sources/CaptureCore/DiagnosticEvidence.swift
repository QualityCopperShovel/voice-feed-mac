...
public enum DiagnosticEvidence {
    public static let fields: Set<String> = ["event", "session", "version", "timestamp", "os", "sample_rate", "channels", "listening", "desired", "domain", "code", "exception_type", "signal", "termination_namespace", "termination_code", "frames", "exception_name", "exception_reason", "exception_message", "exception_frames", "application_info", "exception_detail_status"]
